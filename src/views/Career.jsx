...
import medal from '../assets/career/whyQQPAI/medal.png';
import calendar from '../assets/career/whyQQPAI/calendar.png';
import bulb from '../assets/career/whyQQPAI/bulb.png';
    ...
    <div className='oqpai-career'>
      ...
      <div className="oqpai-why__us">
        ...
        <div className="why-us__content">
          ...
          <div className="card">
            <img src={bulb} alt="" />
            <h3>We encourages individuality</h3>
            <p>Every opinion, either from an intern or a full timer is an asset to us</p>
          </div>
          <div className="card">
            <img src={calendar} alt="" />
            <h3>You schedule your work</h3>
            <p>OQPAI provides the freedom of working at your pace</p>
          </div>
          <div className="card">
            <img src={medal} alt="" />
            <h3>It’s always a win-win at OQPAI</h3>
            <p>You learn, you earn, you grow, you are always the winner here!</p>
          </div>
        </div>
      </div>
